...
protected:
	...
	void GetDialogTemplate(DLGTEMPLATE& dlgTemplate)
	{
		...
		dlgTemplate.cy=Sys::Convert::CentimetersToDlgUnitY(2.56646);
	...
	void InitializeGui()
	{
		...
		lb1.CreateX(NULL, L"Mensaje", WS_CHILD | WS_VISIBLE | SS_LEFT | SS_WINNORMAL, 1.27000, 1.77271, 2.19604, 0.60854, hWnd, 1001);
